...
SECRET_KEY = 'django-insecure-$ar&68h&o3d^s7qm@f+38%^)fn4cd4v%e(orzlek92epp)0^!@'
...
# Diretório onde os arquivos estáticos são armazenados
STATICFILES_DIRS = [
    BASE_DIR / "static",  # Adapte conforme a estrutura do seu projeto
]
